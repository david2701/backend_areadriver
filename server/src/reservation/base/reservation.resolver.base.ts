...
import { Chauffeur } from "../../chauffeur/base/Chauffeur";
...
export class ReservationResolverBase {
  ...
  async createReservation(
    ...
    return await this.service.create({
      ...
      data: {
        ...
        conducteurAssign: args.data.conducteurAssign
          ? {
              connect: args.data.conducteurAssign,
            }
          : undefined,
      },
    });
  ...
  async conducteurAssign(
    ...
    const result = await this.service.getConducteurAssign(parent.id);
