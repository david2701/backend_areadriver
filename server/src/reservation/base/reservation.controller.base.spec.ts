...
const CREATE_INPUT = {
  arrivE: "exampleArrivE",
  commentairesSupplMentaires: "exampleCommentairesSupplMentaires",
  createdAt: new Date(),
  dPart: "exampleDPart",
  id: "exampleId",
  ...
  test("POST /reservations", async () => {
    await request(app.getHttpServer())
      ...
      .expect({
        ...
        quand: CREATE_RESULT.quand.toISOString(),
      ...
      .expect([
        {
          ...
          quand: FIND_MANY_RESULT[0].quand.toISOString(),
  ...
  test("GET /reservations/:id existing", async () => {
    await request(app.getHttpServer())
      ...
      .expect({
        ...
        quand: FIND_ONE_RESULT.quand.toISOString(),
